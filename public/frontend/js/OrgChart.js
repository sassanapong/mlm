...
OrgChart._defaultConfig = function(t) {
    ...
    var c = this.width(),
        ...
        b = 0,
        O = 0;
    if (m - 2 * this.config.padding >= n - l) b = (n + l) / 2 - m / 2;
    ...
    if (C - 2 * this.config.padding >= o - s) O = (o + s) / 2 - C / 2;
    ...
    if (!b || OrgChart.EXPORT_PAGES_CUT_NODES || "fit" != t.scale)
            ...
            if (0 != (D = r[b.lcn ? b.lcn : "base"]).layout || tt) {
                ...
                for (var gt = 0; gt < et.layouts.length; gt++) {
                    ...
                    if (pt.layout == OrgChart.layout.grid && pt.childrenIds.length > 2) {
                        ...
                        var mt = b.id;
                        for (d = b.children.length - 1; d >= 0; d--)
                            for (v = 0; v < pt.childrenIds.length; v++) {
                                ht = pt.childrenIds[v];
    ...
    link: function(t, e, r, i, a, n, o) {
        ...
        for (C = 0; C < t.children.length; C++) {
            ...
            if (S) b = S, x = x.replaceAll("{rounded}", S).replaceAll("{edge}", S).replaceAll("{curve}", b);
            else if (-1 != x.indexOf("{rounded}"))
                if (y.xa == y.xb && y.xa == y.xc && y.xa == y.xd || y.ya == y.yb && y.ya == y.yc && y.ya == y.yd) b = "M" + y.xa + "," + y.ya + " L" + y.xd + "," + y.yd, x = x.replaceAll("{rounded}", b);
                else if (Math.abs(y.xa - y.xd) <= OrgChart.LINK_ROUNDED_CORNERS && Math.abs(y.xa - y.xc) <= OrgChart.LINK_ROUNDED_CORNERS && Math.abs(y.xa - y.xb) <= OrgChart.LINK_ROUNDED_CORNERS) b = "M" + y.xa + "," + y.ya + " L" + y.xa + "," + y.yd, x = x.replaceAll("{rounded}", b);
            else if (Math.abs(y.ya - y.yd) <= OrgChart.LINK_ROUNDED_CORNERS && Math.abs(y.ya - y.yc) <= OrgChart.LINK_ROUNDED_CORNERS && Math.abs(y.ya - y.yb) <= OrgChart.LINK_ROUNDED_CORNERS) b = "M" + y.xa + "," + y.ya + " L" + y.xd + "," + y.ya, x = x.replaceAll("{rounded}", b);
            else {
