...
<nav aria-label="breadcrumb" class="-intro-x mr-auto hidden sm:flex">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page"> Ct </li>
    </ol>
</nav>
@endsection
...
@section('content')
            ...
            <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-4">
                <div class="">
                    <button class="btn btn-primary shadow-md mr-2" data-tw-toggle="modal" data-tw-target="#add_ct"
                        onclick="ct_add()">เพิ่ม
                        CT</button>
                </div>
            </div>
            <div class="card-block" style="margin-top:10px;">
                <div class="row">
                    <div class="dt-responsive table-responsive">
                        <table id="table_ct" style="width:100%;" class="table table-striped table-bordered nowrap">
                                    ...
                                    @foreach ($Ct as $item => $value)
                                        <tr>
                                            ...
                                            <td style="text-align:center;">
                                                <p> {{ isset($value) ? $value->title_ct : '' }}</p>
                                            </td>
                                            <td style="text-align:center;">
                                                @php
                                                    $date = new DateTime();
                                                ...
                                                <div class="row">
                                                    <div class="offset-4 col-1">
                                                        ...
                                                        <button class="btn btn-sm btn-warning mr-2" data-tw-toggle="modal"
                                                            data-tw-target="#edit_ct"
                                                            onclick="editCt({{ $value->id }})"><i
    ...
    <!-- BEGIN: Modal Content -->
    <div id="add_ct" class="modal" data-tw-backdrop="static" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog ">
            <div class="modal-content">
                {{ Form::open(['url' => ['/admin/mdk_ct/store'], 'id' => 'ct-upload', 'autocomplete' => 'off', 'enctype' => 'multipart/form-data']) }}
                <!-- BEGIN: Modal Header -->
                <div class="modal-header">
                    <h2 class="font-medium text-base mr-auto">เพิ่ม CT</h2>
                ...
                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3 bg-slate-100/50">
                    <div class="col-span-12">
                        <div>
                            ...
                            <input id="regular-form-1" name="title_ct" id="title_ct" type="text" class="form-control"
                                required>
                        </div>
                    </div>
                    ...
                    <div class="col-span-12">
                        <div>
                            ...
                            <input id="regular-form-1" name="detail_ct" id="detail_ct" type="text" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="col-span-12">
                        <div>
                            ...
                            <input type="file" name="image_ct" id="input-file-now" class="dropify"
                    ...
                    <div class="col-span-12">
                        <div>
                            ...
                            <textarea class="summernote_ed1" rows="5" name="detail_ct_all" id="regular-form-1" placeholder="Text"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-span-12" id="input2_file1">
                        ...
                        <div class="fallback">
                            <input name="upload_video_ct" type="file" />
                        </div>
                    </div>
                    ...
                    <div class="col-span-12" id="input2_file2" style="display: none;">
                        ...
                        <input name="link_video_ct" type="text" class="form-control" />
                    </div>
                    ...
                    <div class="col-span-6">
                        <div>
                            ...
                            <input id="regular-form-1" name="start_date_ct" type="date" class="form-control"
                                required>
                        </div>
                    </div>
                    ...
                    <div class="col-span-6">
                        <div>
                            ...
                            <input id="regular-form-1" name="end_date_ct" type="date" class="form-control" required>
                        </div>
                    </div>
                    ...
                    <div class="col-span-6">
                        <div>
                            ...
                            <input id="regular-form-1" name="uploadfile_ct" type="file" class="form-control">
                        </div>
                    </div>
                </div> <!-- END: Modal Body -->
                <!-- BEGIN: Modal Footer -->
    ...
    @include('backend.mdk_ct.edit_ct')
@endsection
...
<script src="https://cdn.datatables.net/buttons/2.3.2/js/dataTables.buttons.min.js"></script>
    ...
    <script>
        ...
        function ct_add() {
            $('#ct-upload').attr('action', "{!! url('/admin/mdk_ct/store') !!}");
            $('#submit').text('Save');
            // $('#add_ct').modal('show');
        }
        ...
        function editCt(id) {
            ...
            $('#ct-edit').attr('action', "{!! url('/admin/mdk_ct/edit') !!}");
            $.ajax({
                type: 'GET',
                url: '{{ url('/admin/mdk_ct/edit_data') }}',
                data: {
                    id: id
                },
                success: function(result) {
                    // console.log(result);
                    $('input[name^=title_ct_update').val(result['title_ct'])
                    $('input[name^=detail_ct_update').val(result['detail_ct'])
                    $('#summernote_ct').summernote('code', result['detail_ct_all']);
                    $('input[name^=link_video_ct2').val(result['link_video_ct'])
                    $('input[name^=start_date_ct2').val(result['start_date_ct'])
                    $('input[name^=end_date_ct2').val(result['end_date_ct'])
        ...
        function del_user(id) {
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        type: "GET",
                        url: "{!! url('/admin/mdk_ct/delete/" + id + "') !!}",
        ...
        $(document).ready(function() {
            ...
            $("input[type='radio']").change(function() {
                ...
                if (radioValue == "Upload") {
                    ...
                    $("input[name='upload_video_ct']").prop("disabled", false);
                    $("#input2_file2").css("display", "none");
                    $("input[name='link_video_ct']").prop("disabled", true);
                } else if (radioValue == "Link") {
                    $("#input2_file1").css("display", "none");
                    $("input[name='upload_video_ct']").prop("disabled", true);
                    $("#input2_file2").css("display", "inline");
                    $("input[name='link_video_ct']").prop("disabled", false);
                }
            })
            ...
            $("input[type='radio']").change(function() {
                ...
                if (radioValue == "Upload") {
                    ...
                    $("input[name='upload_video_ct2']").prop("disabled", false);
                    $("#input3_file2").css("display", "none");
                    $("input[name='link_video_ct2']").prop("disabled", true);
                } else if (radioValue == "Link") {
                    $("#input3_file1").css("display", "none");
                    $("input[name='upload_video_ct2']").prop("disabled", true);
                    $("#input3_file2").css("display", "inline");
                    $("input[name='link_video_ct2']").prop("disabled", false);
                }
            })
        });
    </script>
