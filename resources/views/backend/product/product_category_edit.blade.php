<div id="edit_product_category" class="modal" data-tw-backdrop="static" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog ">
        <div class="modal-content">
            {{ Form::open(['url' => ['/admin/product_category/edit'], 'id' => 'product_category-edit', 'autocomplete' => 'off', 'enctype' => 'multipart/form-data']) }}
            <!-- BEGIN: Modal Header -->
            <div class="modal-header">
                <h2 class="font-medium text-base mr-auto">แก้ไขหมวดหมู่สินค้า</h2>
            ...
            <div class="modal-body grid grid-cols-12 gap-4 gap-y-3 bg-slate-100/50">
                <div class="col-span-12">
                    <div>
                        ...
                        <input id="regular-form-1" name="category_name_update" id="category_name_update" type="text"
                ...
                <div class="col-span-6">
                    <div>
                        <select type="text" class="rounded" name="select_pro_cate_lang_update"
                            id="select_pro_cate_lang_update" style="width:100%; padding: 4px; font-size:14px;">
