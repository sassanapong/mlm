...
@section('content')
        ...
        <div class="flex flex-col sm:flex-row sm:items-end xl:items-start mb-2">
            <form id="tabulator-html-filter-form" class="xl:flex sm:mr-auto">
                ...
                <div class="sm:flex items-center sm:mr-4">
                    ...
                    <div class="col-span-12 sm:col-span-6"> <label for="modal-datepicker-1" class="form-label">ID
                            Card</label> <input type="text" id="id_card"
                            class="form-control sm:w-40 2xl:w-full mt-2 sm:mt-0" placeholder="ID Card"> </div>
                    <div class="col-span-12 sm:col-span-6"> <label for="modal-datepicker-1" class="form-label">Phone</label>
                        <input type="text" id="phone" class="form-control sm:w-40 2xl:w-full mt-2 sm:mt-0"
                            placeholder="เบอร์โทรศัพ"> </div>
            ...
            <div class="modal-content">
                <form action="{{ route('update_position') }}" method="POST">
                    ...
                    <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                        ...
                        <div class="col-span-12 sm:col-span-12"> <label for="modal-form-6" class="form-label">ปรับ PV
                                อัพตำแหน่ง</label>
                            <input type="number" class="form-control" name="pv" placeholder="Pv Upgrad"
                                value="0">
                        </div>
                        <div class="col-span-12 sm:col-span-12"> <label for="modal-form-6"
                    ...
                    <div class="modal-footer"> <button type="button" data-tw-dismiss="modal"
                        ...
                        <button type="submit" class="btn btn-primary w-20">ยืนยัน</button>
    ...
    <div id="cancel_user_modal" class="modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="confirm_cancel_user" class="btn btn-danger w-24">
                        ยืนยัน
                    </button>
                </div>
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    const modal = tailwind.Modal.getInstance(
                        document.querySelector("#cancel_user_modal")
                    );

                    modal.hide();
                    table_order.draw(); // reload datatable
