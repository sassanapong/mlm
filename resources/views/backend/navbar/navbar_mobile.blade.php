<div class="mobile-menu md:hidden">
    <div class="mobile-menu-bar">
        <a href="{{ route('admin.Dashboard') }}" class="flex mr-auto">
            <img alt="Midone - HTML Admin Template" class="w-12" src="{{ asset('frontend/images/logo_new.png') }}">
        </a>
    ...
    <ul class="border-t border-white/[0.08] py-5 hidden">
        ...
        <li>
            ...
            <ul class="side-menu__sub-icon ml-4">
                ...
                <li>
                    <a href="{{ route('cashback_reportold') }}" class="menu">
                        <div class="side-menu__icon"> <i data-lucide="credit-card" class="menu__sub-icon "></i>
                        </div>
                ...
                <li>
                    <a href="{{ route('report_star_recash') }}" class="menu">
                        <div class="side-menu__icon"> <i data-lucide="credit-card" class="menu__sub-icon "></i>
                        </div>
                        <div class="menu__title"> รายงานโบนัส STAR ReCash </div>
                    </a>
                </li>
