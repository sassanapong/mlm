                ...
                <div class="col-md-12">
                    <div class="card card-box borderR10 mb-2 mb-md-0">
                        ...
                        document.getElementById('upline_id').submit();"
                                                class="btn btn-success btn-sm mt-2" style=" color: #FFF;font-size: 16px"><i
                                                    class="las la-sort-numeric-up"></i> <b>Up one step</b></a>
                                            <form id="upline_id" action="{{ route('tree') }}" method="POST"
                                                style="display: none;">
                                                <input type="hidden" name="user_name"
                                                    value="{{ $data['lv1']->upline_id }}">
                                                @csrf
                                            </form>
                                        @endif
                                        ...
                                        @if (empty($data['lv2_a']) || empty($data['lv3_a_a']))
                                            <button class="btn btn-success btn-sm btn-disabled disabled mt-2"
                                                style="color: #FFF;font-size: 16px"><i class="las la-sort-down"></i>
                                                ดิ่งขาซ้าย</button>
                                        @else
                                            <a href="#"
                                                onclick="event.preventDefault();
                        document.getElementById('under_a').submit();"
                                                class="btn btn-success btn-sm mt-2" style="color: #FFF;font-size:16px"><i
                                                    class="las la-sort-down"></i> ดิ่งขาซ้าย</a>

                                            <form id="under_a" action="{{ route('under_a') }}" method="POST"
                                                style="display: none;">
                                                <input type="hidden" name="username"
                                                    value="{{ $data['lv3_a_a']->user_name }}">
                                                @csrf
                                            </form>
                                        @endif
                                        ...
                                        @else
                                            <a href="#"
                                                onclick="event.preventDefault();
                        document.getElementById('under_b').submit();"
                                                class="btn btn-sm btn-success mt-2" style="color: #FFF;font-size: 16px"><i
                                                    class="las la-sort-down"></i> ดิ่งขาขวา</a>

                                            <form id="under_b" action="{{ route('under_b') }}" method="POST"
                                                style="display: none;">
                                                <input type="hidden" name="username"
                                                    value="{{ $data['lv3_b_b']->user_name }}">
                                                @csrf
                                            </form>
                                        @endif
                                    </div>
                                    ...
                                    <div class="d-flex flex-wrap gap-2 mt-2">
                                        ...
                                        <span class="badge bg-warning text-dark p-2">
                                            <i class="bx bx-group"></i> วันใกล้หมด
                                        </span>

                                        <span class="badge bg-danger p-2">
                                            <i class="bx bx-group"></i> Non Active
                                        </span>

                                        <span class="badge bg-secondary p-2">
                                            <i class="bx bx-group"></i> ตัดออกจากระบบ
                                        </span>
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <table class="table table-striped table-bordered text-center">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>Pv รวม</td>
                                                        <td>{{ $log_pv_per_day_ab_balance_all->pv_a + $log_pv_per_day_ab_balance_all->pv_a_new ?? 0 }}
                                                        </td>

                                                        <td>Pv รวม</td>
                                                        <td>{{ $log_pv_per_day_ab_balance_all->pv_b + $log_pv_per_day_ab_balance_all->pv_b_new ?? 0 }}
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                                    ...
                                                    <a href="javascript:void(0);">
                                                        <div class="member-view-box">
                                                            <div class="member-image">
                                                                ...
                                                                @else
                                                                    <?php
                                                                    if ($data['lv1']->status_customer == 'normal') {
                                                                        if (empty($data['lv1']->expire_date) || strtotime($data['lv1']->expire_date) < strtotime(date('Ymd'))) {
                                                                            if (empty($data['lv1']->expire_date)) {
                                                                                // $date_mt_active = 'Not Active';
                                                                                $img_1 = asset('frontend/images/profile_NotActive.png');
                                                                            } else {
                                                                                // $date_mt_active = 'Not Active';
                                                                                $img_1 = asset('frontend/images/profile_NotActive.png');
                                                                            }
                                                                        } else {
                                                                            // $date_mt_active = 'Active ' . date('d/m/Y', strtotime($data['lv1']->expire_date));
                                                                            // $status = 'success';
                                                                            $img_1 = asset('frontend/images/profile_Active.png');
                                                                        }
                                                                    } else {
                                                                        $img_1 = asset('frontend/images/profile_cancel.png');
                                                                    }
                                                                    ...
                                                                    <div class="member-view-box">
                                                                        <div class="member-image">
                                                                            ...
                                                                            @else
                                                                                ...
                                                                                if ($data_lv2->status_customer == 'normal') {
                                                                                    if (empty($data_lv2->expire_date) || strtotime($data_lv2->expire_date) < strtotime(date('Ymd'))) {
                                                                                        if (empty($data_lv2->expire_date)) {
                                                                                            // $date_mt_active = 'Not Active';
                                                                                            $img_2 = asset('frontend/images/profile_NotActive.png');
                                                                                        } else {
                                                                                            // $date_mt_active = 'Not Active';
                                                                                            $img_2 = asset('frontend/images/profile_NotActive.png');
                                                                                        }
                                                                                    } else {
                                                                                        // $date_mt_active = 'Active ' . date('d/m/Y', strtotime($data_lv2->expire_date));
                                                                                        // $status = 'success';
                                                                                        $img_2 = asset('frontend/images/profile_Active.png');
                                                                                    }
                                                                                } else {
                                                                                    $img_2 = asset('frontend/images/profile_cancel.png');
                                                                                }
                                                                                    ...
                                                                                    <div class="member-view-box">
                                                                                        <div class="member-image">
                                                                                            ...
                                                                                            @else
                                                                                                ...
                                                                                                if ($data_lv3->status_customer == 'normal') {
                                                                                                    if (empty($data_lv3->expire_date) || strtotime($data_lv3->expire_date) < strtotime(date('Ymd'))) {
                                                                                                        if (empty($data_lv3->expire_date)) {
                                                                                                            // $date_mt_active = 'Not Active';
                                                                                                            $img_3 = asset('frontend/images/profile_NotActive.png');
                                                                                                        } else {
                                                                                                            // $date_mt_active = 'Not Active';
                                                                                                            $img_3 = asset('frontend/images/profile_NotActive.png');
                                                                                                        }
                                                                                                    } else {
                                                                                                        // $date_mt_active = 'Active ' . date('d/m/Y', strtotime($data_lv3->expire_date));
                                                                                                        // $status = 'success';
                                                                                                        $img_3 = asset('frontend/images/profile_Active.png');
                                                                                                    }
                                                                                                } else {
                                                                                                    $img_3 = asset('frontend/images/profile_cancel.png');
                                                                                                }
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <div
                                                                                                            ...
                                                                                                            @else
                                                                                                                ...
                                                                                                                if ($data_lv4->status_customer == 'normal') {
                                                                                                                    if (empty($data_lv4->expire_date) || strtotime($data_lv4->expire_date) < strtotime(date('Ymd'))) {
                                                                                                                        if (empty($data_lv4->expire_date)) {
                                                                                                                            // $date_mt_active = 'Not Active';
                                                                                                                            $img_4 = asset('frontend/images/profile_NotActive.png');
                                                                                                                        } else {
                                                                                                                            // $date_mt_active = 'Not Active';
                                                                                                                            $img_4 = asset('frontend/images/profile_NotActive.png');
                                                                                                                        }
                                                                                                                        ...
                                                                                                                        // $date_mt_active = 'Active ' . date('d/m/Y', strtotime($data_lv3->expire_date));
                                                                                                                        // $status = 'success';
                                                                                                                        $img_4 = asset('frontend/images/profile_Active.png');
                                                                                                                    }
                                                                                                                } else {
                                                                                                                    $img_4 = asset('frontend/images/profile_cancel.png');
                                                                                                                }
...
@section('script')
    <script>
        ...
        function modal_add(pid, type) {
            ...
            $('#text_add').html('สมัครสมาชิกใต้ ' + pid + ' ฝั่ง' + name);
