                                            ...
                                            <div class="card-block payment-tabs">
                                                ...
                                                <div class="tab-content m-t-15">
                                                                ...
                                                                <div class="col-sm-12 col-md-12 col-xl-12 m-b-30">
                                                                    ...
                                                                    <div class="form-radio">
                                                                        <div class="radio radio-inline">
                                                                            <label>
                                                                                <input type="radio" name="sent_type_to_customer" value="sent_type_customer" id="sent_type_customer" onclick="sent_type('customer')" checked="checked">
                                                                                    ...
                                                                                    <div class="form-group row">
                                                                                        <div class="col-md-12">
                                                                                            <div class="input-group input-group-button">
                                                                                                <input type="text" id="username" class="form-control" placeholder="รหัสสมาชิก">
                                                                                                <span class="input-group-addon btn btn-primary" onclick="check()">
                                                                                                    <span class="">ทำรายการ</span>
                                                                                                </span>
                                                                                            </div>
                                                                                            <span style="font-size: 12px" class="text-danger">*คะแนนการสั่งซื้อจะถูกใช้ให้กับลูกทีมที่เลือก</span>
                                                                                        </div>
                                                                                ...
                                                                                <div class="card-block" style="padding: 10px;">
                                                                                    <div class="row">
                                                                                        <div class="col-md-12">
                                                                                            ...
                                                                                            <input type="hidden" name="customers_sent_user_name" id="customers_sent_user_name" value="">
                                                                                    ...
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-md-6">
                                                                                            <h5 class="m-b-0 text-right" id="c_text_pv" style="color: #000"></h5>
                                                                                        </div>
                                                                                    </div>
                                                                                    <hr class="m-b-5 m-t-5">
                                                                                    <div class="row">
                                                                ...
                                                                <div class="col-sm-12 col-md-12 col-xl-12">
                                                                    ...
                                                                    <div class="form-radio">
                                                                        <div class="radio radio-inline" id="i_sent_address">
                                                                            <label>
                                                                                <input type="radio" onchange="sent_address('sent_address',{{ @$address->province_id_fk }})" id="sent_address_check" name="receive" value="sent_address" checked="checked">
                                                                        ...
                                                                        <div class="radio radio-inline">
                                                                            <label>
                                                                                <input type="radio" id="sent_other" onchange="sent_address('sent_other')" name="receive" value="sent_address_other">
                                                            ...
                                                            <div id="sent_address">
                                                                <div class="row m-t-5">
                                                                    <div class="col-md-6 col-sm-6 col-6">
                                                                        ...
                                                                        <input type="text" class="form-control form-control-bold" placeholder="ชื่อผู้รับ" name="name" value="{{ $customer->prefix_name }} {{ $customer->first_name }} {{ $customer->last_name }}" readonly="">
                                                                    </div>
                                                                    <div class="col-md-6 col-sm-6 col-6">
                                                                ...
                                                                <div class="row m-t-5">
                                                                    ...
                                                                    <div class="col-sm-4">
                                                                        ...
                                                                        <input type="text" id="provinces_address" class="form-control form-control-bold" placeholder="จังหวัด" value="{{ $address->provinces_name }}" readonly="">
                                                                        <input type="hidden" name="province" value="{{ $address->province_id_fk }}">
                                                                    </div>

                                                                    <div class="col-sm-4">
                                                                        <label>เขต/อำเภอ <b class="text-danger">*</b></label>
                                                                        <input type="text" class="form-control form-control-bold" placeholder="เขต/อำเภอ" value="{{ $address->amphures_name }}" readonly="">
                                                                        <input type="hidden" name="amphures" value="{{ $address->amphures_id_fk }}">
                                                                    </div>
                                                                    <div class="col-sm-4">
                                                                        <label>แขวง/ตำบล <b class="text-danger">*</b> </label>
                                                                        <input type="text" class="form-control form-control-bold" placeholder="แขวง/ตำบล" value="{{ $address->district_name }}" readonly="">
                                                            ...
                                                            <div id="sent_address">
                                                                ...
                                                                <div class="alert alert-warning icons-alert">
                                                                    ...
                                                                    <p><strong>Warning!</strong> <code>ไม่มีข้อมูลที่อยู่การจัดส่งสินค้า
                                                                            กรุณาตั้งค่าก่อนชำระเงิน</code> <a href="{{ route('editprofile') }}" class="pcoded-badge label label-warning ">ตั้งค่า คลิ๊ก!!</a></p>
                                                                </div>
                                                    ...
                                                    <div class="row m-t-5">
                                                        <div class="col-md-6 col-sm-6 col-6">
                                                            <label>ชื่อผู้รับ <b class="text-danger">*</b></label>
                                                            <input type="text" class="form-control form-control-bold" placeholder="ชื่อผู้รับ" name="office_name" id="office_name" value="">
                                                        </div>
                                                        <div class="col-md-6 col-sm-6 col-6">
                                                            <label>เบอร์โทรศัพท์ <b class="text-danger">*</b></label>
                                                            <input type="text" class="form-control form-control-bold" placeholder="เบอร์โทรศัพท์" id="office_tel_mobile" name="receive_tel_mobile" value="">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row m-t-5">
                                                        <div class="col-md-6 col-sm-6 col-6">
                                                            <label>Email </label>
                                                            <input type="email" class="form-control form-control-bold" placeholder="Email" name="office_email" value="{{ $customer->email }}">
                                                        </div>
                                                ...
                                                <div id="sent_address_other" style="display: none;">
                                                    <div class="row m-t-5">
                                                        <div class="col-md-6 col-sm-6 col-6">
                                                            <label>ชื่อผู้รับ <b class="text-danger">*</b></label>
                                                            <input type="text" class="form-control form-control-bold sent_address_other" placeholder="ชื่อผู้รับ" name="other_name" id="other_name">
                                                    ...
                                                    <div class="row m-t-5">
                                                        ...
                                                        <div class="col-md-5 col-sm-8 col-8">
                                                            <label>หมู่บ้าน/อาคาร <b class="text-danger">*</b></label>
                                                            <input type="text" class="form-control form-control-bold sent_address_other" placeholder="หมู่บ้าน/อาคาร" name="other_house_name" id="other_house_name">
                                                        </div>
                                                        <div class="col-md-3 col-sm-12 col-12">
                                                            <label>หมู่ที่ <b class="text-danger">*</b></label>
                                                    ...
                                                    <div class="form-group row m-t-5">
                                                        ...
                                                        <div class="col-sm-4">
                                                            ...
                                                            <select class="js-example-basic-single col-sm-12 sent_address_other" name="other_amphures" id="amphures">
                                                                <option value=""> Select </option>
                                                            </select>
                                                        </div>
                        ...
                        <div class="card card-box borderR10 mb-2 mb-md-0">
                            <div class="card-body">
                                ...
                                <div class="text-center">
                                    <button type="button" class="btn btn-p1 rounded-pill w-100 mb-2 justify-content-center">ยืนยันคำสั่งซื้อ</button>
                                    <a href="{{route('cancel_order')}}" type="button" class="btn btn-outline-dark rounded-pill w-100 mb-2 justify-content-center">ยกเลิก</a>
                                </div>
                            </div>
                        </div>
                    </div>
