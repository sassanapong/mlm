                                        ...
                                        <div class="row p-2" >
                                            ...
                                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                                @foreach ($categories as $value)
                                                  ...
                                                  <button class="nav-link active" id="{{$value->id}}" data-bs-toggle="tab" data-bs-target="#{{$value->id}}-pane" type="button" role="tab" aria-controls="all-pane" aria-selected="true">ทังหมด</button>
                                                </li>
                                                @endforeach
