<nav class="navbar navbar-expand-lg navbar-dark bg-Gpurple fixed-top">
    <div class="container-fluid">
        ...
        <div class="order-2 order-md-3 d-inline-flex align-items-center">
            ...
            <button class="btn btn-wp" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight">HI! <span class="d-inline-flex d-md-none"><i class='bx bxs-user-circle'></i></span><span class="d-none d-md-inline-flex">ตำแหน่ง - ชื่อ สกุล</span></button>
<!--
            <div class="dropdown">
  ...
  <div class="offcanvas-header border-bottom">
    <div class="d-flex">
      ...
      <div class="flex-grow-1 ms-3">
          ตำแหน่ง<br><h5>ชยพัทธ์ ศรีสดุดี</h5>
      </div>
    </div>
