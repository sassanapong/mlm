<div id="edit_ct" class="modal" data-tw-backdrop="static" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog ">
        <div class="modal-content">
            {{ Form::open(['url' => ['/admin/mdk_ct/edit'], 'id' => 'ct-edit', 'autocomplete' => 'off', 'enctype' => 'multipart/form-data']) }}
            <!-- BEGIN: Modal Header -->
            <div class="modal-header">
                <h2 class="font-medium text-base mr-auto">แก้ไข CT</h2>
            ...
            <div class="modal-body grid grid-cols-12 gap-4 gap-y-3 bg-slate-100/50">
                <div class="col-span-12">
                    <div>
                        ...
                        <input id="regular-form-1" name="title_ct_update" id="title_news_update" type="text"
                ...
                <div class="col-span-12">
                    <div>
                        ...
                        <input id="regular-form-1" name="detail_ct_update" id="detail_ct_update" type="text"
                            class="form-control">
                    </div>
                </div>
                ...
                <div class="col-span-12">
                    <div>
                        ...
                        <input type="file" name="image_ct_update" id="image_ct_update" class="dropify"
                ...
                <div class="col-span-12">
                    <div>
                        ...
                        <textarea class="summernote_ed1" rows="5" name="detail_ct_all_update" id="summernote_ct" placeholder="Text"></textarea>
                    </div>
                </div>
                ...
                <div class="col-span-12" id="input3_file1">
                    ...
                    <div class="fallback">
                        <input name="upload_video_ct2" type="file" />
                    </div>
                </div>
                ...
                <div class="col-span-12" id="input3_file2" style="display: none;">
                    ...
                    <input name="link_video_ct2" type="text" class="form-control" value="" />
                </div>
                ...
                <div class="col-span-6">
                    <div>
                        ...
                        <input id="regular-form-1" name="start_date_ct2" type="date" class="form-control"
                            value="">
                    </div>
                </div>
                ...
                <div class="col-span-6">
                    <div>
                        ...
                        <input id="regular-form-1" name="end_date_ct2" type="date" class="form-control"
                            value="">
                    </div>
                </div>
                ...
                <div class="col-span-6">
                    <div>
                        ...
                        <input id="regular-form-1" name="uploadfile_ct2" type="file" class="form-control">
                    </div>
                </div>
            </div> <!-- END: Modal Body -->
            <!-- BEGIN: Modal Footer -->
