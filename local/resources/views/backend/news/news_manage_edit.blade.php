<div id="edit_news" class="modal" data-tw-backdrop="static" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog ">
        <div class="modal-content">
            {{ Form::open(['url' => ['/admin/news_manage/edit'], 'id' => 'news-edit', 'autocomplete' => 'off', 'enctype' => 'multipart/form-data']) }}
            <!-- BEGIN: Modal Header -->
            ...
            <div class="modal-body grid grid-cols-12 gap-4 gap-y-3 bg-slate-100/50">
                <div class="col-span-12">
                    <div>
                        ...
                        <input id="regular-form-1" name="title_news_update" id="title_news_update" type="text"
                ...
                <div class="col-span-12">
                    <div>
                        ...
                        <input id="regular-form-1" name="detail_news_update" id="detail_news_update" type="text"
                            value="" class="form-control">
                    </div>
                </div>
                ...
                <div class="col-span-12">
                    <div>
                        ...
                        <input type="file" name="image_news_update" id="image_news_update" class="dropify"
                ...
                <div class="col-span-12">
                    <div>
                        ...
                        <textarea class="summernote_ed1" rows="5" name="detail_news_all_update" id="summernote_news" placeholder="Text"></textarea>
                    </div>
                </div>
                ...
                <div class="col-span-12" id="input3_file1">
                    ...
                    <div class="fallback">
                        <input name="upload_video2" type="file" />
                    </div>
                </div>
                ...
                <div class="col-span-12" id="input3_file2" style="display: none;">
                    ...
                    <input name="link_news2" type="text" class="form-control" value="" />
                </div>
                ...
                <div class="col-span-6">
                    <div>
                        ...
                        <input id="regular-form-1" name="start_date_news2" type="date" class="form-control"
                            value="">
                    </div>
                </div>
                ...
                <div class="col-span-6">
                    <div>
                        ...
                        <input id="regular-form-1" name="end_date_news2" type="date" class="form-control"
                            value="">
                    </div>
                </div>
            </div> <!-- END: Modal Body -->
