                        ...
                        <div class="mt-14 mb-3 grid grid-cols-12 sm:gap-10 intro-y">
                            <div
                                ...
                                <div class="text-sm 2xl:text-base font-medium -mb-1"> Hi Angelina, <span
                                        class="text-slate-600 dark:text-slate-300 font-normal">welcome back!</span> </div>
                                <div
                                    ...
                                    My Total Assets <i data-lucide="alert-circle" class="tooltip w-5 h-5 ml-1.5 mt-0.5"
                                ...
                                <div class="2xl:text-base text-slate-600 dark:text-slate-300 mt-6 -mb-1"> Total net margin
                                    <a href=""
                                ...
                                <div class="flex flex-wrap gap-3">
                                    <div class="mr-auto">
                                        <div
                                            ...
                                            AVAILABLE FUNDS <i data-lucide="alert-circle" class="tooltip w-4 h-4 ml-1.5"
                                                title="Total value of your sales: $158.409.416"></i> </div>
                                        <div class="text-white relative text-2xl font-medium leading-5 pl-4 mt-3.5"> <span
                                                class="absolute text-xl top-0 left-0 -mt-1.5">$</span> 479,578.77 </div>
                                    </div>
                                                ...
                                                <div class="mt-1.5 flex items-center">
                                                    ...
                                                    <div class="text-danger flex text-xs font-medium tooltip cursor-pointer ml-2"
                                                        title="2% Lower than last month"> 23% <i
                                                            data-lucide="chevron-down" class="w-4 h-4 ml-0.5"></i> </div>
                                                </div>
                                            </div>
                                            <button
                                ...
                                <div class="intro-y">
                                    <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                                        ...
                                        <div class="ml-4 mr-auto">
                                            ...
                                            <div class="text-slate-500 text-xs mt-0.5">8 May 2020</div>
                                        </div>
                                        <div
                                ...
                                <div class="intro-y">
                                    <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                                        ...
                                        <div class="ml-4 mr-auto">
                                            ...
                                            <div class="text-slate-500 text-xs mt-0.5">25 October 2022</div>
                                        </div>
                                        <div
                                            class="py-1 px-2 rounded-full text-xs bg-success text-white cursor-pointer font-medium">
                                            137 Sales</div>
                                ...
                                <div class="intro-y">
                                    <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                                        ...
                                        <div class="ml-4 mr-auto">
                                            ...
                                            <div class="text-slate-500 text-xs mt-0.5">12 November 2020</div>
                                        </div>
                                        <div
                                            class="py-1 px-2 rounded-full text-xs bg-success text-white cursor-pointer font-medium">
                                            137 Sales</div>
                                                ...
                                                <div class="flex">
                                                    ...
                                                    <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                        <img alt="Midone - HTML Admin Template"
                                                            ...
                                                            title="Uploaded at 21 November 2021">
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                ...
                                                <div class="flex">
                                                    ...
                                                    <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                        <img alt="Midone - HTML Admin Template"
                                                            ...
                                                            title="Uploaded at 5 August 2021">
                                                    </div>
                                                    <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                        <img alt="Midone - HTML Admin Template"
                                            ...
                                            <td class="w-40">
                                                <div class="flex">
                                                    ...
                                                    <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                        <img alt="Midone - HTML Admin Template"
                                                            class="tooltip rounded-full" src="dist/images/preview-13.jpg"
                                                            title="Uploaded at 25 June 2022">
                                                    </div>
                                                    <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                        <img alt="Midone - HTML Admin Template"
                                                            class="tooltip rounded-full" src="dist/images/preview-14.jpg"
                                                            title="Uploaded at 24 April 2022">
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                ...
                                                <div class="flex">
                                                    <div class="w-10 h-10 image-fit zoom-in">
                                                        <img alt="Midone - HTML Admin Template"
                                                            ...
                                                            title="Uploaded at 12 November 2020">
                                                    </div>
                                                    <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                        <img alt="Midone - HTML Admin Template"
                                                            class="tooltip rounded-full" src="dist/images/preview-2.jpg"
                                                            title="Uploaded at 23 June 2021">
                                                    </div>
                                                    <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                        <img alt="Midone - HTML Admin Template"
                                                            class="tooltip rounded-full" src="dist/images/preview-13.jpg"
                                                            title="Uploaded at 14 May 2022">
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <a href="" class="font-medium whitespace-nowrap">Samsung Q90 QLED
                                                    TV</a>
                                ...
                                <div class="mt-5">
                                    ...
                                    <div class="intro-x">
                                        <div class="box px-5 py-3 mb-3 flex items-center zoom-in">
                                            ...
                                            <div class="text-success">+$197</div>
                                        </div>
                                    </div>
                                    <div class="intro-x">
                                        <div class="box px-5 py-3 mb-3 flex items-center zoom-in">
                                    ...
                                    <div class="intro-x">
                                        <div class="box px-5 py-3 mb-3 flex items-center zoom-in">
                                            ...
                                            <div class="ml-4 mr-auto">
                                                <div class="font-medium">Robert De Niro</div>
                                                <div class="text-slate-500 text-xs mt-0.5">9 April 2021</div>
                                            </div>
