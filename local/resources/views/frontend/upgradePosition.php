                                    ...
                                    <div id="msform">
                                        <ul id="progressbar">
                                                ...
                                                <div class="box-choose">
                                                    <ul>
                                                        <li>
                                                            ...
                                                            <button type="button" class="btn btn-choose" data-bs-toggle="modal" data-bs-target="#MOModal"></button>
                                                            <p class="d-block d-md-none">MO</p>
                                                        </li>
                                                        <li>
                                                            <p class="d-none d-md-block">VIP</p>
                                                            <button type="button" class="btn btn-choose" data-bs-toggle="modal" data-bs-target="#VIPModal"></button>
                                                            <p class="d-block d-md-none">VIP</p>
                                                        </li>
                                                        <li>
                                                            <p class="d-none d-md-block">VVIP</p>
                                                            <button type="button" class="btn btn-choose" data-bs-toggle="modal" data-bs-target="#VVIPModal"></button>
                                            ...
                                            <li class="l1">
                                                ...
                                                <button type="button" class="btn btn-position" data-bs-toggle="modal" data-bs-target="#SVVIPModal"></button>
        ...
        <div class="modal-content borderR25">
          ...
          <div class="modal-body">
              <div class="text-center">
                <img src="images/man_2.png" class="mw-100 mb-2" width="120px">
          ...
          <div class="modal-footer justify-content-center">
            <button type="button" class="btn btn-p1 bg-opacity-100 rounded-pill" data-bs-toggle="modal" data-bs-target="#MO2Modal">ยืนยันสิทธิ</button>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content borderR25">
          ...
          <div class="modal-footer justify-content-between">
            <button type="button" class="btn btn-outline-dark rounded-pill" data-bs-toggle="modal" data-bs-target="#MOModal">ยกเลิก</button>
            <button type="button" class="btn btn-p1 bg-opacity-100 rounded-pill" data-bs-dismiss="modal">ยืนยัน</button>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="modal fade" id="VIPModal" tabindex="-1" aria-labelledby="VIPModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content borderR25">
          ...
          <div class="modal-footer justify-content-center">
            <button type="button" class="btn btn-p1 bg-opacity-100 rounded-pill" data-bs-toggle="modal" data-bs-target="#VIP2Modal">ยืนยันสิทธิ</button>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content borderR25">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-outline-dark rounded-pill" data-bs-toggle="modal" data-bs-target="#VIPModal">ยกเลิก</button>
            <button type="button" class="btn btn-p1 bg-opacity-100 rounded-pill" data-bs-dismiss="modal">ยืนยัน</button>
          </div>
        </div>
      </div>
    ...
    <div class="modal fade" id="VVIPModal" tabindex="-1" aria-labelledby="VVIPModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content borderR25">
          ...
          <div class="modal-footer justify-content-center">
            <button type="button" class="btn btn-p1 bg-opacity-100 rounded-pill" data-bs-toggle="modal" data-bs-target="#VVIP2Modal">ยืนยันสิทธิ</button>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="modal fade" id="VVIP2Modal" tabindex="-1" aria-labelledby="VVIP2ModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content borderR25">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-outline-dark rounded-pill" data-bs-toggle="modal" data-bs-target="#VVIPModal">ยกเลิก</button>
            <button type="button" class="btn btn-p1 bg-opacity-100 rounded-pill" data-bs-dismiss="modal">ยืนยัน</button>
          </div>
        </div>
      </div>
    ...
    <div class="modal fade" id="SVVIPModal" tabindex="-1" aria-labelledby="SVVIPModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-lg">
        <div class="modal-content borderR25">
          ...
          <div class="modal-footer justify-content-center">
            <button type="button" class="btn btn-p1 bg-opacity-100 rounded-pill" data-bs-toggle="modal" data-bs-target="#SVVIP2Modal">ยืนยันสิทธิ</button>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="modal fade" id="SVVIP2Modal" tabindex="-1" aria-labelledby="SVVIP2ModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content borderR25">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-outline-dark rounded-pill" data-bs-toggle="modal" data-bs-target="#SVVIPModal">ยกเลิก</button>
            <button type="button" class="btn btn-p1 bg-opacity-100 rounded-pill" data-bs-dismiss="modal">ยืนยัน</button>
          </div>
        </div>
      </div>
