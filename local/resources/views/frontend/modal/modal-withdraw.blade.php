    ...
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
        <div class="modal-content borderR25">
            <div class="modal-header">
                <h5 class="modal-title" id="withdrawModalLabel">โอนเงิน eWallet</h5>
                ...
                <div class="row gx-2">
                    ...
                    <div class="col-sm-12">
                        <div class="card p-2 borderR10 mb-3">
                            ...
                            <input type="text" class="form-control text-purple1 bg-opacity-100 form-control-lg"
                                id="">
            ...
            <div class="modal-footer justify-content-between border-0">
                ...
                <button type="button" class="btn btn-p1 rounded-pill d-flex align-items-center"
                    data-bs-target="#withdrawModal2" data-bs-toggle="modal"><i
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
        <div class="modal-content borderR25">
            ...
            <div class="modal-footer justify-content-between border-0">
                ...
                <button type="button" class="btn btn-p1 rounded-pill d-flex align-items-center"
                    data-bs-target="#withdrawModal3" data-bs-toggle="modal"><i
