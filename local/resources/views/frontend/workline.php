                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-8 text-md-end">
                                    <div><span>สถานะการแจ้งเตือน: </span> <i class="fas fa-circle text-success"></i> Active <i class="fas fa-circle text-warning"></i> กรุณายืนยันสิทธิ <i class="fas fa-circle text-danger"></i> Not Active</div>
                                </div>
                            </div>    
                            <hr>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <button type="button" class="btn btn-info btn-sm" data-bs-toggle="modal" href="#addTransferJPModal" role="button">
                                              <i class='bx bx-link-external'></i>
                                            </button>
                                        </td>
                                        <td class="text-center">
                                            <button type="button" class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#confirmModal">
                                              <i class='bx bx-link-external'></i>
                                            </button>
                                        </td>
                                        <td class="text-center">
                                            <button type="button" class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#discountModal">
                                              <i class='bx bx-link-external'></i>
                                            </button>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="text-center">ชั้น 1</td>
                                        <td class="text-center">
                                            <button type="button" class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#addTransferJPModal">
                                              <i class='bx bx-link-external'></i>
                                            </button>
                                        </td>
                                        <td class="text-center">
...
<!-- transfer Modal -->
<div class="modal fade" id="addTransferJPModal" tabindex="-1" aria-labelledby="addTransferJPModalLabel" aria-hidden="true">
            ...
            <div class="card borderR10 p-2 mb-3">  
                ...
                <div class="row gx-2">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control mb-3" id="" value="MLM0534768" disabled>
                    </div>
                    <div class="col-md-6">
                        <label for="" class="form-label">ชื่อ-นามสกุล</label>
                        <input type="text" class="form-control mb-3" id="" value="ชัยพัทธ์ ศรีสดุดี" disabled>
                    </div>
                    <div class="col-sm-6">
                        <div class="alert alert-white p-2 h-82 borderR10">
                            <div class="d-flex">
                              <div class="flex-shrink-0">
                                <img src="images/man.png" alt="..." width="30px">
                              </div>
                    ...
                    <div class="col-sm-6">
                        <div class="alert alert-purple p-2 h-82 borderR10">
                            ...
                            <p class="text-end mb-0"><span class="h5 text-purple1 bg-opacity-100">1000</span>JP.</p>
                        </div>    
                    </div> 
                </div>  
              </div>    
              <div class="card borderR10 p-2 mb-3">  
                ...
                <div class="row gx-2">
                    ...
                    <div class="col-9 col-md-5">
                        <label for="" class="form-label">จำนวนJP ที่ต้องการโอน <span class="text-danger">*</span></label>
              ...
              <div class="modal-footer justify-content-between border-0">
                    ...
                    <button type="button" class="btn btn-p1 rounded-pill d-flex align-items-center" data-bs-target="#addTransferCJPModal" data-bs-toggle="modal"><i class='bx bxs-check-circle me-2'></i>ทำรายการ</button>
              </div>
          </div>    
      </div>
    </div>
...
<!-- transfer2 Modal-->
<div class="modal fade" id="addTransferCJPModal" tabindex="-1" aria-labelledby="addTransferCJPModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
    <div class="modal-content borderR25">
      ...
      <div class="modal-footer justify-content-between border-0">
        <button type="button" class="btn btn-outline-dark rounded-pill" data-bs-target="#addTransferJPModal" data-bs-toggle="modal">ยกเลิก</button>
        <button type="button" class="btn btn-p1 rounded-pill d-flex align-items-center" data-bs-dismiss="modal"><i class='bx bxs-check-circle me-2'></i>ยืนยัน</button>
      </div>
    </div>
  </div>
</div>
        ...
        <div class="cJP1 boxJPC mt-3">  
            <div class="card borderR10 p-2">  
                ...
                <div class="row gx-2">
                    ...
                    <div class="col-9 col-md-5">
                        <label for="" class="form-label">จำนวนJP <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="" disabled value="500">
                    </div>
                    <div class="col-3 col-md-1">
                        <label for="" class="form-label d-block">&nbsp;</label>
              ...
              <div class="modal-footer justify-content-between border-0">
                    <button type="button" class="btn btn-outline-dark rounded-pill" data-bs-dismiss="modal">ยกเลิก</button>
                    <button type="button" class="btn btn-p1 rounded-pill d-flex align-items-center" data-bs-target="#addClarifyJPModalC1" data-bs-toggle="modal"><i class='bx bxs-check-circle me-2'></i>ทำรายการ</button>
              </div>
          </div>    
      </div>
    </div>
...
<!-- Modal confirm C1-->
<div class="modal fade" id="addClarifyJPModalC1" tabindex="-1" aria-labelledby="addClarifyJPModalC1Label" aria-hidden="true">
  <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
    <div class="modal-content borderR25">
      <div class="modal-header justify-content-center">
      ...
      <div class="modal-footer justify-content-between border-0">
        <button type="button" class="btn btn-outline-dark rounded-pill" data-bs-target="#addClarifyJPModal" data-bs-toggle="modal">ยกเลิก</button>
        <button type="button" class="btn btn-p1 rounded-pill d-flex align-items-center" data-bs-dismiss="modal"><i class='bx bxs-check-circle me-2'></i>ยืนยัน</button>
      </div>
    </div>
  </div>
      ...
      <div class="modal-body">    
          ...
          <div class="cJP2 boxJPC mt-3">  
            <div class="card borderR10 p-2">  
              ...
              <div class="modal-footer justify-content-between border-0">
                    <button type="button" class="btn btn-outline-dark rounded-pill" data-bs-dismiss="modal">ยกเลิก</button>
                    <button type="button" class="btn btn-p1 rounded-pill d-flex align-items-center" data-bs-target="#addClarifyJPModalC2" data-bs-toggle="modal"><i class='bx bxs-check-circle me-2'></i>ทำรายการ</button>
              </div>
          </div>  
      </div>
    </div>
...
<!-- Modal Confirm C2-->
<div class="modal fade" id="addClarifyJPModalC2" tabindex="-1" aria-labelledby="addClarifyJPModalC2Label" aria-hidden="true">
  <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
    <div class="modal-content borderR25">
      <div class="modal-header justify-content-center">
        ...
        <div class="card borderR10 p-2 mb-3">
            <div class="row mb-3">
              ...
              <div class="col-9 col-sm-6">
                  ...
                  <p readonly class="form-control-plaintext small text-danger" id="">*** 1JP. = xxx บาท</p>
              </div>
              <div class="col-3 col-sm-2">
                  <p readonly class="form-control-plaintext" id="">JP.</p>
              </div>    
