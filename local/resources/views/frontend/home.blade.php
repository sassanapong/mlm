    ...
    <div class="bg-whiteLight page-content">
        <div class="container-fluid">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-8 col-xxl-9">
                                    <div class="row">
                                        <div class="col-6">
                                            <span class="badge rounded-pill bg-success bg-opacity-20 text-success fw-light ps-1"> 
                                                <i class="fas fa-circle text-success"></i> Active
                                            </span>
                                        </div>
                                        <div class="col-6 text-end">
                                            <a type="button" class="btn btn-warning px-2" href="editprofile.php"><i class="bx bxs-edit"></i></a>
                                        </div>
                                    </div>    
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="dropdown mb-3">
                        <button class="card card-boxDrp dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="dropdown mb-3">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                            <li><a class="dropdown-item" type="button" data-bs-toggle="modal" data-bs-target="#depositModal">ฝากเงิน eWallet</a></li>
                            <li><a class="dropdown-item" type="button" data-bs-toggle="modal" data-bs-target="#transferModal">โอนเงิน eWallet</a></li>
                            <li><a class="dropdown-item" type="button" data-bs-toggle="modal" data-bs-target="#withdrawModal">ถอนเงิน eWallet</a></li>
                                        ...
                                        <div class="row g-0">
                                            <div class="col-md-4">
                                                <div class="box-imageNews">
                                                    <img src="./images/money-2724241_1920.jpg" class="img-fluid rounded-start" alt="">
                                                </div>    
                                            </div>
                                            <div class="col-md-8">
                                                <div class="card-body">
                                                    ...
                                                    <a href="news-detail.php" class="linkNews stretched-link"><span>อ่านเพิ่มเติม</span><i class='bx bxs-right-arrow-circle' ></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
