<?php
use App\Http\Controllers\Frontend\TreeUniController;
?>
 <title>
 ...
 @section('conten')
                 ...
                 <div class="col-lg-12">
                     <nav aria-label="breadcrumb">
                         <ol class="breadcrumb">
                             ...
                             <li class="breadcrumb-item active text-truncate" aria-current="page"> ข้อมูลสายงาน Unilevel</li>
                         </ol>
                     </nav>
                 </div>
             </div> 
             <div class="row">
                 <div class="col-md-12">
                     <div class="card card-box borderR10 mb-2 mb-md-0">
                             ...
                             <div class="row">
                                <div class="col-md-8 ">
                                    <div class="button-list">
                                        ...
                                        href="{{ route('tree_uni') }}" style="color: black;font-size: 16px;"><i class="las la-sort-user"></i>  <b class="font-primary">You</b></a>
                                    @if ($data['lv1']->user_name == Auth::guard('c_user')->user()->user_name || $data['lv1']->uni_id == 'AA')
                        ...
                        document.getElementById('uni_id').submit();" class="btn btn-success btn-sm mt-2"
                                            style=" color: #FFF;font-size: 16px"><i class="las la-sort-numeric-up"></i> <b>Up one step</b></a>
                                        <form id="uni_id" action="{{ route('tree_uni') }}" method="POST"
                                            style="display: none;">
                                            <input type="hidden" name="user_name" value="{{ $data['lv1']->uni_id }}">
                                            @csrf
                                        </form>
                                    @endif
                        ...
                        document.getElementById('under_a').submit();" class="btn btn-success btn-sm mt-2"
                                        ...
                                        <form id="under_a" action="{{ route('under_a_uni') }}" method="POST"
                                            style="display: none;">
                        ...
                        document.getElementById('under_b').submit();" class="btn btn-sm btn-success mt-2"
                                        ...
                                        <form id="under_b" action="{{ route('under_b_uni') }}" method="POST"
                                            style="display: none;">
                                                  ...
                                                  <?php
                                                                     ...
                                                                     @if($data_lv4)
                                                                      ...
                                                                      <li>
                                                                        <a href="javascript:void(0);">
                                                                          <div class="member-view-box">
                                                                              <div class="member-image">
                                                                                  {{-- <img onclick="modal_add('{{$data_lv3->user_name}}','{{$line_lv4_add}}')" src="{{asset('frontend/images/icon/add_user_not.png') }}">   --}}
                                                                                   <img src="{{asset('frontend/images/icon/add_user_not.png')}}">
                                                                                  <div class="member-detailsr">
                                                              ...
                                                              @else
                                                                          ...
                                                                          <li>
                                                                            <a href="javascript:void(0);">
                                                                              <div class="member-view-box">
                                                                                  <div class="member-image">
                                                                                      {{-- <img onclick="modal_add('{{$data_lv2->user_name}}','{{$line_lv3_add}}')" src="{{asset('frontend/images/icon/add_user_not.png')}}">  --}}
                                                                                    <img src="{{asset('frontend/images/icon/add_user_not.png')}}">
                                                                                      <div class="member-detailsr">
                                                    ...
                                                    <li>
                                                      <a href="javascript:void(0);">
                                                        <div class="member-view-box">
                                                            <div class="member-image">
                                                                 {{-- <img onclick="modal_add('{{ $data['lv1']->user_name }}','{{ $line_lv2_add }}')" src="{{asset('frontend/images/icon/add_user_not.png')}}">  --}}
                                                                <img src="{{asset('frontend/images/icon/add_user_not.png')}}">
                                                                <div class="member-detailsr">
    ...
    <form action="{{ route('search_uni') }}" method="post" id="home_search">
        @csrf
 ...
 <script>
    ...
    function modal_tree(user_name) {
      ...
      $.ajax({
        url: '{{ route('home_check_customer_id_uni') }}',
        type: 'GET',
