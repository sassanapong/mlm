...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <button type="button" class="btn btn-p1 rounded-pill mb-3" data-bs-toggle="modal" data-bs-target="#addClarifyJPModal"><i class='bx bx-plus me-1' ></i> ทำรายการแจงJP.</button>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#editJPModal">
    ...
    <!-- Modal -->
    <div class="modal fade" id="addClarifyJPModal" tabindex="-1" aria-labelledby="addClarifyJPModalLabel" aria-hidden="true">
        ...
        <div class="modal-content borderR25">
          ...
          <div class="modal-body">
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="radio" name="clarifyJP" id="cJPinlineRadio1" value="cJP1" checked>
            ...
            <div class="cJP1 boxJPC mt-3">  
              ...
              <div class="cJP3 boxJPC mt-3">  
                <div class="card borderR10 p-2">  
                  ...
                  <div class="modal-footer justify-content-between border-0">
                        <button type="button" class="btn btn-outline-dark rounded-pill" data-bs-dismiss="modal">ยกเลิก</button>
                        <button type="button" class="btn btn-p1 rounded-pill d-flex align-items-center" data-bs-target="#addClarifyJPModalC3" data-bs-toggle="modal"><i class='bx bxs-check-circle me-2'></i>ทำรายการ</button>
                  </div>
              </div> 
          </div>
        </div>
    ...
    <!-- Modal Confirm C3-->
    <div class="modal fade" id="addClarifyJPModalC3" tabindex="-1" aria-labelledby="addClarifyJPModalC3Label" aria-hidden="true">
      <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
        <div class="modal-content borderR25">
          <div class="modal-header justify-content-center">
