            ...
            <div class="row">
                <div class="col-md-12">
                    <ul class="nav nav-pills mb-3">
                      <li class="nav-item">
                        <a class="nav-link" href="learning.php">เรียนรู้</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="ct.php">CT</a>
                      </li>
                    </ul>
                                        ...
                                        <div class="row g-0">
                                            ...
                                            <div class="col-md-7">
                                                <div class="card-body">
                                                    ...
                                                    <a href="ct-detail.php" class="linkNews stretched-link"><span>อ่านเพิ่มเติม</span><i class='bx bxs-right-arrow-circle' ></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
