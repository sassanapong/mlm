                            ...
                            <div class="row justify-content-md-end">
                                <div class="col-lg-4 col-xl-3 ">
                                    <div class="alert alert-success p-2 mb-0" role="alert">
                                        <p class="mb-0 text-lg-end">PV สั่งซื้อสินค้าสะสม
                                            <b>{{ number_format(Auth::guard('c_user')->user()->pv_all) }}</b> PV
                                        </p>
                                    </div>
                                </div>
                            </div>
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        $(document).on("click", ".btn_tracking_no", function() {

            let tracking_no = $(this).data('tracking_no');
            try {
                navigator.clipboard.writeText(tracking_no);
