...
class RunCodeController extends Controller
{
  ...
  public static function db_code_order()
  {
    ...
    if (empty($ck_code)) {
      ...
      if ($rs_code_order == true) {
        ...
        RunCodeController::db_code_order();
      }
    } else {
      RunCodeController::db_code_order();
    }
  ...
  public static function db_code_bonus($type_id_fk)
  {
    ...
    $code =  IdGenerator::generate([
      ...
      'field' => 'code',
      'length' => 15,
      'prefix' => 'S' . '' . $type_id_fk . '' . $y . '' . date("m") . date("d") . '-',
      'reset_on_prefix_change' => true
    ]);
    ...
    if (empty($ck_code)) {
      ...
      if ($rs_code_order == true) {
        ...
        RunCodeController::db_code_bonus($type_id_fk);
      }
    } else {
      RunCodeController::db_code_bonus($type_id_fk);
    }
  ...
  public static function db_code_wallet()
  {
    ...
    if (empty($ck_code)) {
      ...
      if ($rs_code_order == true) {
        ...
        RunCodeController::db_code_wallet();
      }
    } else {
      RunCodeController::db_code_wallet();
    }
