        ...
        return $sQuery
            ...
            ->editColumn('delete', function ($query) {
                ...
                if ($status == 1) {
                    ...
                    $html =  '<a href"javascript:0" class="btn btn-outline-danger btn-sm" onclick="delete_w();"><i class="fa fa-trash" aria-hidden="true"></i></a>';
                } else {
                    $html = '';
                }
            ...
            ->rawColumns(['transaction_code', 'status', 'qr', 'delete'])
            ->make(true);
    }
}
