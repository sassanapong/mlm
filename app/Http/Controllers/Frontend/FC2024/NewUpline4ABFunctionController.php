...
class NewUpline4ABFunctionController extends Controller
{
    public static $arr = array();

    public function alluni($user_name)
    {
    ...
    public static function all_upline($user_name, $limt_lv)
    {
        ...
        $data = ['status' => 'ข้อมูลภายใต้สายงาน Unilevel', 'data' => $introduce];
        return $data;
    }
    ...
    public static function user_upline($user_name)
    {
        return DB::table('customers')
            ...
            ->where('customers.uni_id', '=', $user_name)
            ->get();
    }
